...
CREATE TYPE importance_level AS ENUM ('not_important', 'nice_to_have', 'somewhat_important', 'very_important', 'must_have');

-- Create table for property features
...
-- Create table for user property requirements
