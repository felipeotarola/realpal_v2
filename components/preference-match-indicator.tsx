...
export function PreferenceMatchIndicator({ score, percentage, matches }: PreferenceMatchProps) {
  const [expanded, setExpanded] = useState(false)

  // Gruppera matchningar efter viktighet och matchningsstatus
  ...
  // Bestäm färg baserat på matchningsprocent
  const getColorClass = () => {
  ...
  // Bestäm beskrivning baserat på matchningsprocent
  ...
  return (
    <Card className="w-full">
      <CardHeader className="pb-2">
        ...
        <CardDescription>{getMatchDescription()}</CardDescription>
      </CardHeader>
      <CardContent>
